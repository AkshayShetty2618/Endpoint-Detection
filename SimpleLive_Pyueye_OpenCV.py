...
width = rectAOI.s32Width # width of resolution
height = rectAOI.s32Height #height for resolution
...
#---------------------------------------------------------------------------------------------------------------------------------------
#out = cv2.VideoWriter(r'F:\TUhh\Thesis\images\testvid.avi', cv2.VideoWriter_fourcc(*'PIM1'), 18.0, (1228,1027))
...
#---------------------------------------------------------------------------------------------------------------------------------------
    ...
    if cv2.waitKey(1) & 0xFF == ord('t'):
        cv2.imwrite('F:\TUhh\Thesis\images\OLDimagetest_'+str(n)+'.jpg', frame)
        n = n+1
